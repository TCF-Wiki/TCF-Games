            ...
            <div class="container">
              ...
              <div class="checkbox-container">
                ...
                <div class="toggle-pill-color">
                  <input
                    :id="'map1checkbox' + difficulty"
                    type="checkbox"
                    value="1"
                    checked
                    @change="oneChecked = !oneChecked"
                    :disabled="
                      !threeChecked && !twoChecked && oneChecked ? true : false
                    "
                  />
        ...
        <li>
          ...
          <div class="icon-context">
            <div class="container">
              ...
              />
              <br />
              <label for="gameLengthSlider">
                {{ gameLength }} round{{ gameLength > 1 ? "s" : "" }}
              </label>
            </div>
          </div>
        </li>
