...
<template>
	<section class="card">
		...
		<div class="card-icons">
			<ul>
				<li>
					<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M176 0c-17.7 0-32 14.3-32 32s14.3 32 32 32h16V98.4C92.3 113.8 16 200 16 304c0 114.9 93.1 208 208 208s208-93.1 208-208c0-41.8-12.3-80.7-33.5-113.2l24.1-24.1c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L355.7 143c-28.1-23-62.2-38.8-99.7-44.6V64h16c17.7 0 32-14.3 32-32s-14.3-32-32-32H224 176zm72 192V320c0 13.3-10.7 24-24 24s-24-10.7-24-24V192c0-13.3 10.7-24 24-24s24 10.7 24 24z"/></svg>					
					<div class="icon-context">
						<div class="container">
							<h3>Time Limit</h3>
							<input id="timeSlider" type="range" min="5" max="120" v-model="timeLength" step="5"
								@input="sliderRatio" />
							<br />
						...
						<div class="container">
							...
							<div class="checkbox-container">
								...
								<div class="toggle-pill-color">
									<input :id="'map1checkbox' + difficulty" type="checkbox" value="1" checked
										@change="oneChecked = !oneChecked"
										:disabled="!threeChecked && !twoChecked && oneChecked ? true : false" />
							...
							<div class="checkbox-container">
								<span> CF </span>
								<div class="toggle-pill-color">
									<input :id="'map2checkbox' + difficulty" type="checkbox" value="2" checked
										@change="twoChecked = !twoChecked"
										:disabled="!threeChecked && twoChecked && !oneChecked ? true : false" />
							...
							<div class="checkbox-container">
								<span> TI </span>
								<div class="toggle-pill-color">
									<input :id="'map3checkbox' + difficulty" type="checkbox" value="3" checked
										@change="threeChecked = !threeChecked"
										:disabled="threeChecked && !twoChecked && !oneChecked ? true : false" />
				...
				<li>
					<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M181.3 32.4c17.4 2.9 29.2 19.4 26.3 36.8L197.8 128h95.1l11.5-69.3c2.9-17.4 19.4-29.2 36.8-26.3s29.2 19.4 26.3 36.8L357.8 128H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H347.1L325.8 320H384c17.7 0 32 14.3 32 32s-14.3 32-32 32H315.1l-11.5 69.3c-2.9 17.4-19.4 29.2-36.8 26.3s-29.2-19.4-26.3-36.8l9.8-58.7H155.1l-11.5 69.3c-2.9 17.4-19.4 29.2-36.8 26.3s-29.2-19.4-26.3-36.8L90.2 384H32c-17.7 0-32-14.3-32-32s14.3-32 32-32h68.9l21.3-128H64c-17.7 0-32-14.3-32-32s14.3-32 32-32h68.9l11.5-69.3c2.9-17.4 19.4-29.2 36.8-26.3zM187.1 192L165.8 320h95.1l21.3-128H187.1z"/></svg>
					<div class="icon-context">
						<div class="container">
							<h3>Rounds</h3>
							<input id="gameLengthSlider" type="range" min="1" max="20" v-model="gameLength"
								@input="sliderRatio" />
							<br />
