...
export const map1TileLayer: TileLayer = L.tileLayer(
  "map-images/1/{z}/{x}/{y}.png",
  tileLayerOptions
);

export const map2TileLayer: TileLayer = L.tileLayer(
  "map-images/2/{z}/{x}/{y}.png",
  tileLayerOptions
);

export const map3TileLayer: TileLayer = L.tileLayer(
  "map-images/3/{z}/{x}/{y}.png",
  tileLayerOptions
);
